...
protected:
    ...
    {
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/zero-first" }, ""sv);
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/a" }, "a"sv);
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/zero" }, ""sv);
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/b" }, "b"sv);
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/c" }, "c"sv);
        createFileWithContents(tr_pathbuf{ tor_->download_dir().sv(), "/root/zero-last" }, ""sv);
    }
...
TEST_F(ResumeTest, acceptsValidRenames)
{
    writeFilenames(
        {
            "renamed/zero-first"sv,
            "renamed/a"sv,
            "renamed/zero"sv,
            "renamed/b"sv,
            "renamed/c"sv,
            "renamed/zero-last"sv,
        });
    ...
    EXPECT_EQ("renamed/zero-first"sv, tor_->file_subpath(0));
    EXPECT_EQ("renamed/a"sv, tor_->file_subpath(1));
    EXPECT_EQ("renamed/zero"sv, tor_->file_subpath(2));
    EXPECT_EQ("renamed/b"sv, tor_->file_subpath(3));
    EXPECT_EQ("renamed/c"sv, tor_->file_subpath(4));
    EXPECT_EQ("renamed/zero-last"sv, tor_->file_subpath(5));
}
